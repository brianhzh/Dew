...
export class PlantEngine {
  ...
  private drawSky() {
    ...
    ctx.beginPath()
    ctx.moveTo(this.W / 2 - this.W * 0.36, this.H + 2)
    ctx.quadraticCurveTo(this.W / 2 - this.W * 0.16, this.H - 44, this.W / 2, this.H - 44)
    ctx.quadraticCurveTo(this.W / 2 + this.W * 0.16, this.H - 44, this.W / 2 + this.W * 0.36, this.H + 2)
    ctx.closePath()
    ctx.fill()
    ctx.fillStyle = hsl(28, 40, sl + 6)
    ctx.beginPath()
    ctx.moveTo(this.W / 2 - this.W * 0.29, this.H + 2)
    ctx.quadraticCurveTo(this.W / 2 - this.W * 0.13, this.H - 36, this.W / 2, this.H - 36)
    ctx.quadraticCurveTo(this.W / 2 + this.W * 0.13, this.H - 36, this.W / 2 + this.W * 0.29, this.H + 2)
    ctx.closePath()
    ctx.fill()
  }
